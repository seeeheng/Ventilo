...
public class VideoStreamDeleteOrSaveRecyclerItemTouchListener implements RecyclerView.OnItemTouchListener {
    ...
    VideoStreamDeleteOrSaveRecyclerItemTouchListener(Context context, final RecyclerView recyclerView, OnItemClickListener listener) {
        mListener = listener;
