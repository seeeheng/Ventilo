...
public class IncidentRecyclerItemTouchListener implements RecyclerView.OnItemTouchListener {
    ...
    IncidentRecyclerItemTouchListener(Context context, final RecyclerView recyclerView, OnItemClickListener listener) {
        mListener = listener;
