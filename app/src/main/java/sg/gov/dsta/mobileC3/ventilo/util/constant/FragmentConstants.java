...
public class FragmentConstants {
    ...
    public static final String KEY_TASK_REMOVE = "Task Remove";
    public static final String KEY_TASK_TOTAL_NUMBER = "Task Total Number";
    public static final String KEY_TASK_TITLE = "Task Title";
    public static final String KEY_TASK_DESCRIPTION = "Task Description";
    public static final String VALUE_TASK_ADD = "Add Task";
    public static final String VALUE_TASK_UPDATE = "Update Task";
    ...
    public static final String KEY_SITREP_PICTURE = "Sit Rep Picture";
